...
mod test {
  ...
  pub fn clock_drift_correction_new() {
    ...
    assert_eq!(correction.error_per_sample, 0.7369614512471655);
  ...
  pub fn clock_drift_correction_error_per_sample() {
    ...
    assert_eq!(error, 0.7369614512471655);
  }
  ...
  pub fn clock_drift_correction_next() {
    ...
    assert_eq!(samples_time, ClockTime::new(2267574));
    let samples_time = correction.next(100);
    assert_eq!(samples_time, ClockTime::new(2267573));
    let samples_time = correction.next(100);
    assert_eq!(samples_time, ClockTime::new(2267574));
    let samples_time = correction.next(100);
    assert_eq!(samples_time, ClockTime::new(2267574));
